...
if TEST_CONF:
    test_config_file = os.path.join(TEST_HOME, AIRCRAFT + ".config")
    test_includes_file = os.path.join(TEST_HOME, AIRCRAFT + "includes")
...
# Pass test modus on to the interpeter
TEST_PARAM = "0"
if TEST_CONF:
    TEST_PARAM = TEST_HOME
...
make_flags = [
    ...
    "AIRCRAFT=" + AIRCRAFT,
    "CC='python " + gcc_interpeter + " " + AIRCRAFT + " " + TEST_PARAM + "'",
...
if TEST_CONF:
    ...
    test_includes_name = os.path.join(TEST_HOME, AIRCRAFT + ".includes")
    ...
    original_yml = open(yml_template)
